...
create table if not exists bizman_activity_template (
    ...
    act_rule_desc text null default null comment '活动规则说明',
...
-- 插入默认数据
insert into `bizman_activity_template` (`id`, `title`, `industry_id`, `description`, `cover_img`, `banner_img`, `color_plate`, `background_music`, `act_start_time`, `act_end_time`, `act_prize_name`, `act_prize_cnt`, `act_prize_decorate`, `act_prize_unit`, `act_prize_desc`, `act_rule_decorate`, `act_rule_cnt`, `act_rule_keywords`, `act_images`, `organizer_name`, `organizer_address`, `organizer_phone`, `about_us`, `video_url`, `link_name`, `link_url`, `act_type`, `is_recommend`, `is_offshelf`, `bizman_copy_cnt`, `netizen_copy_cnt`, `created_at`, `updated_at`, `deleted_at`) values
...
create table if not exists bizman_merchant_acts (
    ...
    act_prize_unit varchar(64) null default null comment '奖品单位',
    act_prize_desc varchar(512) null default null comment '奖品描述',
    act_rule_decorate varchar(128) null default null comment '活动前缀修饰',
    act_rule_cnt int unsigned not null default 0 comment '活动规则数量',
    act_rule_keywords varchar(128) null default '收集' comment '参与活动动作, [元宝, 星星啥的]',
    act_rule_desc text null default null comment '活动规则说明',
    ...
    organizer_name varchar(32)  null default null comment '主办方姓名',
    organizer_address varchar(32) null default null comment '主办方地址',
    organizer_phone varchar(32) null default null comment '主办方电话',
